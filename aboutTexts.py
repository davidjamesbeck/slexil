...
class AboutTexts:
    ...
    def makeSound(self):
        ...
        text = dcc.Markdown('''In order to facilitate line-by-line playback, SLEXIL parses the audio recording 
                ...
                named "audio" in the project directory. If the ELAN file contains time codes that do not correspond to 
                the lines that will be displayed on the webpage generated by SLEXIL, there may be additional sound files 
                in the audio folder.''')
